...
public class ProductController {
	...
	@GetMapping("/product/v0/{id}")
	public ResponseEntity<ProductDTO> getProductv0(@PathVariable Integer id) {
		Product p = productService.getProductById(id);
		ProductDTO pDTO = productService.calculateDiscountv0(p);
		if (pDTO != null) {
	...
	public ResponseEntity<ProductDTO> getProductv1(@PathVariable Integer id) {
		Product p = productService.getProductById(id);
		ProductDTO pDTO = productService.calculateDiscountv1(p);
		if (pDTO != null) {
			return new ResponseEntity<ProductDTO>(pDTO, HttpStatus.FOUND);
		} else {
			return new ResponseEntity<ProductDTO>(HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<ProductDTO> getProductv2(@PathVariable Integer id) {
		Product p = productService.getProductById(id);
		ProductDTO pDTO = productService.calculateDiscountv2(p);
		if (pDTO != null) {
			return new ResponseEntity<ProductDTO>(pDTO, HttpStatus.FOUND);
		} else {
			return new ResponseEntity<ProductDTO>(HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<ProductDTO> getProductv3(@PathVariable Integer id) {
		Product p = productService.getProductById(id);
		ProductDTO pDTO = productService.calculateDiscountv3(p);
		if (pDTO != null) {
			return new ResponseEntity<ProductDTO>(pDTO, HttpStatus.FOUND);
		} else {
			return new ResponseEntity<ProductDTO>(HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<ProductDTO> getProductv4(@PathVariable Integer id) {
		Product p = productService.getProductById(id);
		ProductDTO pDTO = productService.calculateDiscountv4(p);
		if (pDTO != null) {
			return new ResponseEntity<ProductDTO>(pDTO, HttpStatus.FOUND);
		} else {
			return new ResponseEntity<ProductDTO>(HttpStatus.NOT_FOUND);
